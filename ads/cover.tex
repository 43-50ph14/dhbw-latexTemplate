...
\begin{titlepage}
	\begin{longtable}{p{8cm} p{8cm}}
		\raggedright {\raisebox{\ht\strutbox-\totalheight}{\includegraphics[height=2.5cm]{content/images/cover/logo-dhbw.pdf}}} &
		% no company logo for semester paper and special documents
		\ifDocType{T2\_3100}{}{%
			\raggedleft {\raisebox{\ht\strutbox-\totalheight}{\includegraphics[height=2.5cm]{content/images/cover/green.jpg}}}
		}%
	\end{longtable}
